...
namespace email.Models
{
    public class EmailSenderModel
    {
        ...
        public static void SendEmailWithToken(string emailSender, string emailReceiver, string token)
        {
            try
            {
            ...
            <body>
                ...
                <div class='content'>
                    <h2>Confirmez Votre Adresse Email</h2>
                    <p>Bonjour,</p>
                    <p>Pour finaliser la validation de votre compte, veuillez cliquer sur le lien ci-dessous :</p>
                    <div class='highlight'>
                    <a href='http://localhost:5207/api/inscription/validationInscription?token={token}' class='button'>Valider mon compte</a>
                    </div>
                    <p>Si vous n'êtes pas à l'origine de cette demande, veuillez ignorer ce message.</p>
                    <p>Merci de votre confiance.</p>
                </div>
